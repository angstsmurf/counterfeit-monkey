...
Understand "wash hands" or "wash up" as washing hands. Washing hands is an action applying to nothing.

Carry out washing hands:
	if the player can touch a washing-appropriate thing (called the target):
		if the target is a switched off tap: [This is to remove any things we might have put in the sink or bath.]
